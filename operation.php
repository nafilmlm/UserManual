...
<html xmlns="http://www.w3.org/1999/xhtml" lang="English">
  <head>
    ...
    <title>Operation User Documentation &#8212; Operation 14.0 documentation</title>
...
<script type="text/javascript" src="_static/jquery.noconflict.js"></script>
  ...
  <?php include "headerLogo.html" ?>      
    ...
    <figure class="card top" style="height:400px;">
      ...
      <div class="container text-center">
        <h1 style="padding-bottom:19px;"> OPERATION USER DOCUMENTATION </h1>
  ...
  <ul id="myUL">
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="operation/systemAdmin.php" class="card-img">
                        <span style="background-image: url('images/operation/operationBanner.png')"></span>
    ...
    <!-- <div id="footer" class="container">
      ...
      <div class="row">
        <div class="col-sm-7 col-md-7 col-lg-6">
          <div class="row">
            ...
            <div class="col-xs-6 col-sm-4">
              ...
              <ul>
                <li><a href="https://www.odoo.sh">operation Cloud Platform</a></li>
                <li class="divider"></li>
        ...
        <div class="col-sm-5 col-md-4 col-md-offset-1 col-lg-5 col-lg-offset-1">
          <p>
            <small>
              operation is a suite of open source business apps that cover all your company needs: CRM, eCommerce, accounting, inventory, point of sale, project management, etc.
              <br/><br/>
