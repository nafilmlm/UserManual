...
<html xmlns="http://www.w3.org/1999/xhtml" lang="English">
  <head>
    ...
    <title>Realmax User Documentation &#8212; Realmax 14.0 documentation</title>
...
<script type="text/javascript" src="_static/jquery.noconflict.js"></script>
  ...
  <div class="col-sm-6 col-md-3">
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/agreementSetup.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/contacts.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/dashboard.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/finance.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/fixIt.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/legalDocuments.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/listing.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/maintenance.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/postDatedCheques.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/properties.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/reports.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/search.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="realmax/settings.php" class="card-img">
                        <span style="background-image: url('images/realmax/realmaxBanner.png')"></span>
