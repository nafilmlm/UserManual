...
<html xmlns="http://www.w3.org/1999/xhtml" lang="English">
  <head>
    ...
    <title>Figure Pro User Documentation &#8212; Gears 14.0 documentation</title>
...
<script type="text/javascript" src="_static/jquery.noconflict.js"></script>
  ...
  <?php include "headerLogo.html" ?>      
    ...
    <figure class="card top" style="height:400px;">
      ...
      <div class="container text-center">
        <h1 style="padding-bottom:19px;"> FIGURE PRO USER DOCUMENTATION </h1>
  ...
  <ul id="myUL">
                ...
                <figure class="card">
                    <a href="FigurePro/booking.php" class="card-img">
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="FigurePro/dashboard.php" class="card-img">
                        <span style="background-image: url('images/FigurePro/figureProBanner.jpg')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="FigurePro/finance.php" class="card-img">
                        <span style="background-image: url('images/FigurePro/figureProBanner.jpg')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="FigurePro/maintenance.php" class="card-img">
                        <span style="background-image: url('images/FigurePro/figureProBanner.jpg')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="FigurePro/masters.php" class="card-img">
                        <span style="background-image: url('images/FigurePro/figureProBanner.jpg')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="FigurePro/member.php" class="card-img">
                        <span style="background-image: url('images/FigurePro/figureProBanner.jpg')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="FigurePro/reports.php" class="card-img">
                        <span style="background-image: url('images/FigurePro/figureProBanner.jpg')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="FigurePro/staff.php" class="card-img">
                        <span style="background-image: url('images/FigurePro/figureProBanner.jpg')"></span>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="FigurePro/systemConfig.php" class="card-img">
                        <span style="background-image: url('images/FigurePro/figureProBanner.jpg')"></span>
                        <figcaption>System Config</figcaption>
                    </a>
                </figure>
                </div>
                ...
                <div class="col-sm-6 col-md-3">
                <figure class="card">
                    <a href="FigurePro/users.php" class="card-img">
                        <span style="background-image: url('images/FigurePro/figureProBanner.jpg')"></span>
